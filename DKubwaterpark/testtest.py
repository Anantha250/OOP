            ...
            if items["name"] == "towel":
                ...
                for i in range(len(group_tickets)):
                    if group_tickets[i]["type"] == items["type"]:
                        group_tickets_val[i] = detail["amount"]
                        return
        #return res["order_detail"]["amount"], res["total"], res["discount"]
    except:
        print(res)
    ...
    for i in range(len(services_background)):
        ...
        if i==0 :
            for j in range(len(tickets)):
                button1 = ttk.Button(services_frame, text = f"+", command = lambda : add_item(tickets[j]))
                button2 = ttk.Button(services_frame, text = f"-", command = lambda : reduce_item(tickets[j]))
                amount1 = ttk.Label(services_frame, text=f"{tickets_val[j]}", bootstyle="info", font=("Arial", 18))
        ...
        # group ticket 
            ...
            for j in range(len(group_tickets)):
                button1 = ttk.Button(services_frame, text = f"+", command = lambda : add_item(group_tickets[j]))
                button2 = ttk.Button(services_frame, text = f"-", command = lambda : reduce_item(group_tickets[j]))
                amount1 = ttk.Label(services_frame, text=f"{group_tickets_val[j]}", bootstyle="info", font=("Arial", 18))
        ...
        # cabana
            ...
            button1 = ttk.Button(services_frame, text = f"+", command = lambda : show_cabana_zone())
            button2 = ttk.Button(services_frame, text = f"-", command = lambda : reduce_item(towels[j]))
            amount1 = ttk.Label(services_frame, text=f"{cabanas_val}", bootstyle="info", font=("Arial", 18))
        ...
        #towel lockers
            ...
            for j in range(len(towels)):
                button1 = ttk.Button(services_frame, text = f"+", command = lambda : add_item(towels))
                button2 = ttk.Button(services_frame, text = f"-", command = lambda : reduce_item(towels))
                amount1 = ttk.Label(services_frame, text=f"{towels_val}", bootstyle="info", font=("Arial", 18))
            ...
            for j in range(len(lockers)):
                button1 = ttk.Button(services_frame, text = f"+", command = lambda : add_item(lockers[j]))
                button2 = ttk.Button(services_frame, text = f"-", command = lambda : reduce_item(lockers[j]))
                amount1 = ttk.Label(services_frame, text=f"{lockers_val[j]}", bootstyle="info", font=("Arial", 18))
