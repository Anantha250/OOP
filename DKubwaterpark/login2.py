...
def coupon_use(member_id): 
    ...
    coupon_code = PromotioncodeEntry.get()
    response = requests.put(API_ENDPOINT, json={"info": {"coupon_code": coupon_code}})
...
cancel_order3 = ttk.Button(frame_order, text="BACK", bootstyle="dark", command=lambda: show_page(3, frame_order))
...
def get_order_detail(member_id):
    ...
    if response.status_code == 200:
        ...
        for order_detail in order["order_detail"]:
            ...
            order_label = ttk.Label(Order_detail_frame, text=f"Item Name: {item_name}, Type: {item_type}, Amount: {amount}, Price: {price}, Subtotal: {subtotal}", font=("Helvetica", 14), bootstyle="dark")
...
name_label = ttk.Label(Contact_Detail_Frame, text = "Name :", font=("Helvetica",14), bootstyle="dark")
name_label.pack(pady=10,padx=10,ipadx=300)

email_label = ttk.Label(Contact_Detail_Frame, text = "Email :", font=("Helvetica",14), bootstyle="dark")
...
Order_detail = ttk.Label(frame_home, text = "Order Detail", font=("Helvetica",18), bootstyle="info")
...
Sub_Total = ttk.Label(Order_detail_frame1, text = "Sub Total :", font=("Helvetica",14), bootstyle="dark")
Sub_Total.pack(pady=10,padx=10,ipadx=290)

Discount = ttk.Label(Order_detail_frame1, text = "Discount :", font=("Helvetica",14), bootstyle="dark")
Discount.pack(pady=10,padx=10,ipadx=290)

Payment_Method = ttk.Label(frame_home, text = "Payment Method", font=("Helvetica",18), bootstyle="info")
Payment_Method.pack(pady=10)

cancel_order3 = ttk.Button(frame_home, text="BACK", bootstyle="dark", command=lambda: show_page(3, frame_home))
cancel_order3.pack(pady=20, padx=2, ipadx=1)
...
Contact_Detail = ttk.Label(frame_view_member, text = "Member Detail", font=("Helvetica",18), bootstyle="info")
...
Member_name_view = ttk.Label(Member_detail_frame, text = "Name :", font=("Helvetica",14), bootstyle="dark")
Member_name_view.pack(pady=10,padx=10,ipadx=300)

Email_view = ttk.Label(Member_detail_frame, text = "Email :", font=("Helvetica",14), bootstyle="dark")
Email_view.pack(pady=10,padx=10,ipadx=300)

telephone_view = ttk.Label(Member_detail_frame, text = "Telephone :", font=("Helvetica",14), bootstyle="dark")
...
home = ttk.Button(frame_home_1, text="VIEW_ORDER_DETAIL", bootstyle="dark", command=lambda: show_page(1, frame_home_1))
home.pack(pady=20, padx=2, ipadx=1)

home2 = ttk.Button(frame_home_1, text="VIEW_COUPON_DETAIL", bootstyle="dark", command=lambda: show_page(2, frame_home_1))
home2.pack(pady=20, padx=2, ipadx=1)

home3 = ttk.Button(frame_home_1, text="VIEW_MEMBER_DETAIL", bootstyle="dark", command=lambda: show_page(4, frame_home_1))
