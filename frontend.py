...
slides_button = ttk.Button(frame_home_member, text="Our Slides", command=lambda :show_slides(my_frame_home_member), width=24)
slides_button.place(relx=0.1,rely=0.1, anchor=ttk.NW,x=10,y=120)
pool_button = ttk.Button(frame_home_member, text="Pool", command=lambda :show_pool(my_frame_home_member), width=23)
...
home_button_member = ttk.Button(frame_home_member, text="Home", command=lambda : show_page(11,frame_home_member), width=width_button, padding=pading_button)
home_button_member.place(x=0,y=0)

service_button_member = ttk.Button(frame_home_member, text="Service", command= lambda: show_page(14,frame_home_member), width=width_button, padding=pading_button)
service_button_member.place(relx=0.2,x=102,y=0)

login_button_member = ttk.Button(frame_home_member, text="info", command=lambda: get_member_info(member_id), width=width_button, padding=pading_button)
login_button_member.place(relx=0.5,x=12,y=0)

register_button_member = ttk.Button(frame_home_member, text="Log out", command=log_out, width=width_button, padding=pading_button)
